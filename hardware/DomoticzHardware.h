...
protected:
	...
	void SendTempBaroSensor(const int NodeID, const int BatteryLevel, const float temperature, const float pressure, int forecast, const std::string &defaultname);
